...
RUN apk update \
 ...
 && apk add --no-cache --force \
        ...
        libressl perl \
 && apk add --no-cache alpine-sdk libmilter-dev ldns-dev libevent-dev lua5.1-dev mariadb-dev readline-dev ncurses-dev curl-dev jansson-dev db-dev openssl-dev openssl-libs-static\
 ...
 #       libressl-dev \
        libmilter-dev \
    \
 && curl -fL -o /tmp/opendbx.tar.gz http://linuxnetworks.de/opendbx/download/opendbx-1.4.6.tar.gz \
